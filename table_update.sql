...
add column IF NOT EXISTS `PD_user_id` varchar(40) COLLATE utf8mb4_unicode_ci DEFAULT NULL after PD_auth_password,
change column IF EXISTS `PD_user_id` PD_user_login varchar(40)
;
